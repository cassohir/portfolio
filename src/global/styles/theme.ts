...
export const lightTheme: DefaultTheme = {
  colors: {
    ...
    sidebarBackground: 'hsl(240, 6%, 12%)',
...
export const darkTheme: DefaultTheme = {
  colors: {
    ...
    headerBackground: 'hsl(240, 6%, 13%)',
    sidebarBackground: '#259A38',
    skillBackground: 'hsl(240, 6%, 14%)',
    btnTopBackground: 'hsl(240, 6%, 14%)',
    inputBackground: 'hsl(240, 6%, 14%)',
    headerText: '#fefefe',
    text: '#fefefe',
    title: '#fff',
